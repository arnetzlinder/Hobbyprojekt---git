<template>
    <div class="max-h-96 font-serif relative justify-center content-center flex">
        <div class="absolute p-10 text-2xl bg-gradient-to-r from-green-200 via-yellow-100 to-blue-400 content-evenly rounded-xl">
